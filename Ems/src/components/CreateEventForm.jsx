...
function CreateEventForm() {
  ...
  useEffect(() => {
    ...
    if (editable) {
      ...
      setValue("dateTime", selectedEvent.dateTime);
      ...
      if (selectedEvent.dateTime) {
        const dateObj = new Date(selectedEvent.dateTime);
  ...
  const submit = (data) => {
    ...
    if (editable) {
      ...
      if (
        ...
        selectedEvent.capacity === data.capacity &&
        selectedEvent.ticketPrice === data.ticketPrice &&
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                {...register("capacity", {
                  required: "Please select a capacity",
                })}
              >
